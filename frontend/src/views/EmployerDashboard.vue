        ...
        >
          <div class="flex flex-col md:flex-row md:items-stretch justify-between gap-6">
            ...
            <div class="flex-1 min-w-0">
              ...
              <!-- Reason -->
              <p class="text-sm text-gray-500 mt-2 line-clamp-2">{{ leave.reason }}</p>
            ...
            <div class="flex flex-col justify-between gap-4 lg:min-w-[220px]">
              ...
              <div class="grid grid-cols-2 gap-3 text-xs">
                <div class="flex flex-col">
                  ...
                  <span class="text-sm text-gray-300">{{ fmtDate(leave.createdAt) }}</span>
                </div>
                <div class="flex flex-col">
...
// Per-card comment inputs, keyed by leave._id
...
async function updateStatus(id: string, status: "Approved" | "Rejected"): Promise<void> {
  ...
  try {
    ...
    // Replace the updated leave in the list
    leaves.value = leaves.value.map(l => l._id === id ? data.leave : l);

    // Clear the comment input for this card
    delete comments[id];
